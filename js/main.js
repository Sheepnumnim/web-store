jQuery(document).ready(function () {
    ...
    jQuery('.mygrid').click(function() {
        disableScroll();
        var element = jQuery(event.target);
        var name = element.text().trim();
        alert('hi! ' + name);
        jQuery('.myproducts').css('display', 'block');
    });

    jQuery('.ti-close').click(function(){
        enableScroll();
        jQuery('.myproducts').css('display', 'none');
    });
